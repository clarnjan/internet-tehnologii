...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <asp:Label ID="Label2" width="150px" runat="server" Text="Име"></asp:Label>
    ...
    <div>
        <asp:Label ID="Label3" width="150px" runat="server" Text="Презиме"></asp:Label>
    ...
    <div>
        <asp:Label ID="Label4" width="150px" runat="server" Text="Финки ID"></asp:Label>
    ...
    <div>
        <asp:Label ID="Label5" width="150px" runat="server" Text="Лозинка"></asp:Label>
    ...
    <div>
        <asp:Label ID="Label8" width="150px" runat="server" Text="Потврда"></asp:Label>
    ...
    <asp:ValidationSummary ID="validation" runat="server" ForeColor="Red" />
     ...
     <div>
        <asp:Label ID="Label9" width="150px" runat="server" Text="Адреса"></asp:Label>
    ...
    <div>
        <asp:Label ID="Label10" width="150px" runat="server" Text="Телефон"></asp:Label>
        ...
        <asp:Label ID="Label11" width="150px" runat="server" Text="Пол:"></asp:Label>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="Избери пол"
        ...
        ></asp:RequiredFieldValidator>
    <br />
        <asp:Label ID="Label12" width="150px" runat="server" Text="Датум на раѓање"></asp:Label>
        <asp:Calendar ID="Calendar1" runat="server"></asp:Calendar>
    
        <asp:Label ID="Label13" width="150px" runat="server" Text="Занимање"></asp:Label>
    <div>
